...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets_website/img/favicon.ico') }}">

    <link rel="stylesheet" href="{{ asset('assets_website/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets_website/css/templatemo.css') }}">
    <link rel="stylesheet" href="{{ asset('assets_website/css/custom.css') }}">

    <!-- Load fonts style after rendering the layout styles -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Roboto:wght@100;200;300;400;500;700;900&display=swap">
    <link rel="stylesheet" href="{{ asset('assets_website/css/fontawesome.min.css') }}">
