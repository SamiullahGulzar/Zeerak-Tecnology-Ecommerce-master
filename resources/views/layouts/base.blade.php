...
<head>
	...
	<meta name="author" content="Samiullah">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('asset_admin/css/bootstrap.min.css') }}">
      ...
      <!-- plugins -->
      <link rel="stylesheet" type="text/css" href="{{ asset('asset_admin/css/plugins/font-awesome.min.css') }}"/>
      <link rel="stylesheet" type="text/css" href="{{ asset('asset_admin/css/plugins/simple-line-icons.css') }}"/>
      <link rel="stylesheet" type="text/css" href="{{ asset('asset_admin/css/plugins/animate.min.css') }}"/>
      <link rel="stylesheet" type="text/css" href="{{ asset('asset_admin/css/plugins/fullcalendar.min.css') }}"/>
	<link href="{{ asset('asset_admin/css/style.css') }}" rel="stylesheet">
	<!-- end: Css -->

	<link rel="shortcut icon" href="{{ asset('asset_admin/img/logomi.png') }}">
 ...
 <body id="mimin" class="dashboard">
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span>{{ Auth::user()->name }}</span></li>
                  <li class="dropdown avatar-dropdown">
                   <img src="{{ asset('asset_admin/img/avatar.jpg') }}" class="img-circle avatar" alt="user name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"/>
                   <ul class="dropdown-menu user-dropdown">
                     <li><a href="{{ route('profile.show') }}"><span class="fa fa-user"></span> My Profile</a></li>
                     <li><a href="#"><span class="fa fa-calendar"></span> My Calendar</a></li>
                     <li role="separator" class="divider"></li>
                     <li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><span class="fa fa-power-off"></span>&nbsp; <b>Logout</b></a></li> 
                  </ul>
              ...
              <div class="tab-content">
                <div id="right-menu-user" class="tab-pane fade in active">
                  ...
                  <div class="user col-md-12">
                   <ul class="nav nav-list">
                    <li class="online">
                      <img src="{{ asset('asset_admin/img/avatar.jpg') }}" alt="user name">
                      <div class="name">
                        ...
                        <div class="row msg_container send">
                          <div class="col-md-9 col-xs-9 bubble">
                            ...
                            <div class="col-md-3 col-xs-3 avatar">
                              <img src="{{ asset('asset_admin/img/avatar.jpg') }}" class=" img-responsive " alt="user name">
                            </div>
                          </div>
                                ...
                                <ul>
                                  <li class="online">
                                    <a href=""  data-toggle="tooltip" data-placement="left" title="Akihiko avaron">
                                      <div class="user-avatar"><img src="{{ asset('asset_admin/img/avatar.jpg') }}" alt="user name"></div>
                                      <div class="dot"></div>
                                    </a>
                                  </li>
                                  <li class="offline">
    ...
    <script src="{{ asset('asset_admin/js/jquery.ui.min.js') }}"></script>
    <script src="{{ asset('asset_admin/js/bootstrap.min.js') }}"></script>
   
    
    <!-- plugins -->
    <script src="{{ asset('asset_admin/js/plugins/moment.min.js') }}"></script>
    <script src="{{ asset('asset_admin/js/plugins/fullcalendar.min.js') }}"></script>
    <script src="{{ asset('asset_admin/js/plugins/jquery.nicescroll.js') }}"></script>
    <script src="{{ asset('asset_admin/js/plugins/jquery.vmap.min.js') }}"></script>
    <script src="{{ asset('asset_admin/js/plugins/maps/jquery.vmap.world.js') }}"></script>
    <script src="{{ asset('asset_admin/js/plugins/jquery.vmap.sampledata.js') }}"></script>
    <script src="{{ asset('asset_admin/js/plugins/chart.min.js') }}"></script>
