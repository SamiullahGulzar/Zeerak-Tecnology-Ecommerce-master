                ...
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        ...
                        <p class="animated fadeInDown"><span class="fa  fa-map-marker"></span> Kabul, Afghanistan</p>
                            ...
                            <div class="col-md-12 padding-0">
                              <div class="panel box-v2">
                                  <div class="panel-heading padding-0">
                                    <img src="{{ asset('asset_admin/img/bg2.jpg') }}" class="box-v2-cover img-responsive"/>
                                    <div class="box-v2-detail">
                                      <img src="{{ asset('asset_admin/img/avatar.jpg') }}" class="img-responsive"/>
